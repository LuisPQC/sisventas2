...
<div class="content">
    ...
    <table border="0" class="table table-bordered" cellpadding="5">
        <tr>
            ...
            <td  style="background-color: #cccccc;text-align: center"><b>Nombre del cliente</b></td>
            <td style="background-color: #cccccc;text-align: center"><b>NIT/Código</b></td>
            <td style="background-color: #cccccc;text-align: center"><b>Teléfono</b></td>
            <td style="background-color: #cccccc;text-align: center"><b>Correo</b></td>
