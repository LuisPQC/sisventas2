...
<div class="content">
    ...
    <table border="0" class="table table-bordered" cellpadding="5">
        <tr>
            ...
            <td width="150px" style="background-color: #cccccc;text-align: center"><b>Descripción</b></td>
            <td width="210px" style="background-color: #cccccc;text-align: center"><b>Fecha y hora de registro</b></td>
        </tr>
        <tbody>
        @php
            $contador = 1;
